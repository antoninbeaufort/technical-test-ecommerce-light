const footerNavigation = {
  products: [
    ...
    { name: "T-shirts", href: "#" },
    { name: "Objets", href: "#" },
    { name: "Articles pour la maison", href: "#" },
    { name: "Accessoires", href: "#" },
  ],
  company: [
    { name: "Qui sommes-nous", href: "#" },
    { name: "Responsabilité sociétale", href: "#" },
    { name: "Presse", href: "#" },
    { name: "Jobs", href: "#" },
  ...
  customerService: [
    ...
    { name: "FAQ", href: "#" },
    { name: "Trouver une boutique", href: "#" },
  ],
};
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-flow-col md:auto-rows-min md:grid-cols-12 md:gap-x-8 md:gap-y-16">
            ...
            <div className="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
              ...
              <p className="mt-6 text-sm text-gray-500">
                Les dernières offres et réductions, envoyées dans votre boîte de
                réception chaque semaine.
              </p>
        ...
        <div className="border-t border-gray-100 py-10 text-center">
          <p className="text-sm text-gray-500">
            &copy; 2022 Technical test e-commerce light. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
